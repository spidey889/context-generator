...
- Rebuilt the destination picker as a compact dark-glass decision surface with the original restrained title treatment, stronger platform identity, whole-tile hover and keyboard focus feedback, a truthful user-controlled Send reassurance, and an intentional one-column narrow-screen layout.
