...
- Restored generated-summary fallback reliability during Gemini-family congestion: corrected the two dated Mistral fallback IDs to their documented forms and reduced the shared Gemini window so the complete 195-second provider allowance stays 15 seconds inside the extension's 210-second deadline.
