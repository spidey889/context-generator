...
4. Cap-Context captures role-verified turns and sends one summary job to the Vercel backend. Tiny chats are carried locally; generated summaries try Gemini 3.8, 3.7, 3.6, and 3.5 Flash, then OrcaRouter Free, Ministral 3 14B, optional Groq Compound Mini, and finally the complete local carry.
