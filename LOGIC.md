...
July 5 2026 later note: Claude long-message chats can need far more scroll movements than short-message chats with the same turn count, because each virtualized window advances by less conversation content. The sweep safety cap is intentionally high but still bounded at 160 attempts so long Claude chats around 80 turns and 30k+ characters can reach the bottom without making short chats slower.
