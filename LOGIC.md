...
- 2026-07-03: Claude model-label clipping from the 24px left nudge is fixed by temporarily setting overflow visible on the model control and its nearby wrappers, with stale overflow reservations restored on reload. This keeps the Sonnet text visible without changing the nudge amount.
