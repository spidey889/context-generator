...
- `supabase/migrations/`: production database changes, including keeping telemetry unavailable through the anonymous Data API and providing the protected internal `user_daily_usage` view.
