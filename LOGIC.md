...
- Historical Claude placement logs, decisive geometry, discarded approaches, and guidance for future temporary instrumentation are archived in `docs/debugging/claude-placement-logs.md`. Treat it as debugging history; this file and production code remain authoritative.
