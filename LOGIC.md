...
- 2026-07-02: Claude row spacing now adds tiny visual row nudges: model selector 14px left, mic/voice/send-side controls 12px right equally. This is a surgical spacing tweak on top of the existing composer-relative overlay, not a new placement strategy.
