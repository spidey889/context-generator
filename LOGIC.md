...
- 2026-07-03: Summary speed was improved with adaptive backend profiles. Short chats no longer target 1,200 words or trigger expansion: tiny/small/medium chats use smaller output caps and one Mistral pass, while the 1,200-word plus expansion path is reserved for large conversations over 60k characters.
